      ...
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="relative mb-12 max-w-2xl mx-auto group">
          ...
          <input 
            ...
            className="w-full bg-[#111] py-5 pl-14 pr-16 rounded-2xl border border-white/10 outline-none font-medium text-white placeholder:text-brand-grey focus:border-brand-yellow focus:ring-1 focus:ring-brand-yellow transition-all shadow-2xl"
          />
          <button className="absolute right-3 top-1/2 -translate-y-1/2 bg-brand-yellow p-3 rounded-xl hover:scale-105 active:scale-95 transition-all">
            <ArrowRight className="text-black w-5 h-5 stroke-[3px]" />
          </button>
        </div>
        ...
        <div className="relative mb-20 overflow-hidden bg-brand-yellow rounded-3xl p-8 flex flex-col md:flex-row items-center justify-between gap-6 border-4 border-black shadow-[8px_8px_0px_0px_#fff]">
          <div className="flex items-center gap-6">
            ...
            <div>
              <h3 className="text-black text-4xl font-black uppercase italic tracking-tighter leading-none">
                Insane Flat Discount
              </h3>
              <p className="text-black/80 font-bold uppercase tracking-widest text-sm mt-1">
                Valid on all online orders today!
              </p>
            </div>
          </div>
          <div className="flex items-center gap-2 bg-black py-4 px-10 rounded-full">
            <span className="text-brand-yellow text-5xl font-black italic">15%</span>
            <span className="text-white text-2xl font-black uppercase">Off</span>
          </div>
        </div>
        ...
        <div className="text-center mb-16 relative">
          ...
          <h2 className="text-5xl md:text-7xl font-black text-white uppercase tracking-tighter italic relative z-10 leading-none">
              ...
              <div className="absolute inset-x-0 bottom-0 p-8 transform group-hover:-translate-y-2 transition-transform">
                ...
                <div className="flex items-end justify-between gap-2">
                  <div className="flex flex-col">
                    <span className="text-brand-grey text-sm font-bold line-through">
                      Rs. {deal.oldPrice}
                    </span>
                    <div className="flex items-center gap-1">
                      {deal.isFrom && <span className="text-brand-yellow text-[10px] font-black uppercase">From</span>}
                      <span className="text-brand-yellow text-2xl font-black leading-none">
                        Rs. {deal.newPrice}
                      </span>
                    </div>
                  </div>
